...
| File | Description |
|---|---|
| Performance_Analytics.ipynb | CAGR, Sharpe, Sortino, Alpha, Beta, Max Drawdown, Scorecard, Benchmark Chart |
| Advanced_Analytics.ipynb | VaR/CVaR, Rolling Sharpe, Cohort Analysis, SIP Continuity, HHI, Recommender |
| fund_scorecard.csv | Composite 0–100 scorecard for all 40 funds |
| alpha_beta.csv | OLS regression metrics vs NIFTY 100 |
| var_cvar_report.csv | Historical VaR (95%) and CVaR (95%) for all 40 funds |
| benchmark_comparison_chart.png | Top 5 funds vs NIFTY 50 & NIFTY 100 (3-year, rebased) |
| rolling_sharpe_chart.png | 90-day rolling Sharpe ratio for top 5 funds |
| Dashboard/Dashboard.pdf | Combined 4-page visual dashboard PDF |
| Final_Report.pdf | 15-page comprehensive capstone report |
| Bluestock_MF_Presentation.pptx | 12-slide executive PowerPoint presentation |
...
- [x] All 8 analytical objectives completed
- [x] Daily returns, CAGR, Sharpe, Sortino, Alpha, Beta, Max Drawdown computed
- [x] Composite 0-100 fund scorecard built across 40 schemes
- [x] VaR/CVaR, Rolling Sharpe, Investor Cohort, SIP Continuity, HHI completed
- [x] Benchmark comparison chart generated (Top 5 vs NIFTY 50 & NIFTY 100)
- [x] 4-page Power BI visual dashboard (PNG + PDF) generated
- [x] 12-slide PowerPoint presentation created
- [x] 15-page Final PDF report generated
- [x] recommender.py CLI working (Low/Moderate/High)
- [x] run_pipeline.py master script created
- [x] README.md documentation written
- [x] Git tag v1.0 created
- [x] All scripts have module-level docstrings
- [x] No debug print statements in production scripts
